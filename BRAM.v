...
module  BRAM_meminit_m4k
	...
	.datab(20'b10111111111111111111)
	...
	defparam
		...
		addr_ctr.lpm_modulus = 786432,
		addr_ctr.lpm_port_updown = "PORT_UNUSED",
		addr_ctr.lpm_width = 20,
	...
	initial/*synthesis enable_verilog_initial_construct*/
 	begin
		$display("Warning: Incorrect Configuration Specification. Megafunction will initialize to zero instead");
	end
endmodule //BRAM_meminit_m4k
//VALID FILE
...
module BRAM (
	...
	wire [19:0] ram_address = sub_wire2[19:0];
	wire  ram_wren = sub_wire3;

	BRAM_meminit_m4k	BRAM_meminit_m4k_component (
				.clock (clock),
				.init (init),
				.dataout (sub_wire0),
				.init_busy (sub_wire1),
